...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css/plugins/forms/wizard.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css/category.css')}}">
    <!-- END Custom CSS-->
